        ...
        NavigationView {
            ...
            .toolbar(content: {
                ...
                ToolbarItem(placement: .navigationBarLeading) {
                                    // Use an Image instead of Button
                ...
                ToolbarItem {
                    NavigationLink {
                        RecipeView(recipe: Recipe.all.sorted { $0.created_at > $1.created_at }[0])
...
extension AddRecipeView {
    private func saveRecipe(){
        DataController().addRecipe(name: name, desc: description, ingridients: ingridients, directions: directions, category: selectedCategory.rawValue, context: managedObjContext)
        dismiss()
    }
}
